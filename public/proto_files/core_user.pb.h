...
public:
  ...
  explicit constexpr UsrSvrMappingData_MappingEntry_DoNotUse(
...
class UsrSvrMappingData final :
 ...
 public:
  ...
  explicit constexpr UsrSvrMappingData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class UserDataInfo final :
 ...
 public:
  ...
  explicit constexpr UserDataInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
